...
protected Event currentEvent;
	...
	void Start () {
		//controlListNames = new string[] {"Forward", "Back", "Left","Right","Jump","Run", "Crouch"};
		controlListNames = new List<string> {};
		configPath = Application.dataPath + "/controls.cfg";
		controlList = new KeyCode[] {Forward, Back, Left, Right, Jump, Run, Crouch};
		for(int i = 0; i < controlList.Length; i++)
			controlListNames.Add(controlList[i].ToString());
